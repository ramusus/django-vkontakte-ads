...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('vkontakte_ads_image', (
            ...
            ('photo_hash', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('photo', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('server', self.gf('django.db.models.fields.PositiveIntegerField')(blank=True)),
            ('size', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('aid', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ...
        # Deleting field 'Ad.photo_hash'
        db.delete_column('vkontakte_ads_ad', 'photo_hash')

        # Deleting field 'Ad.photo'
        db.delete_column('vkontakte_ads_ad', 'photo')

        # Deleting field 'Ad.hash'
        db.delete_column('vkontakte_ads_ad', 'hash')

        # Deleting field 'Ad.server'
        db.delete_column('vkontakte_ads_ad', 'server')

        # Adding field 'Ad.image'
        db.add_column('vkontakte_ads_ad', 'image', self.gf('django.db.models.fields.related.OneToOneField')(related_name='ad', unique=True, null=True, to=orm['vkontakte_ads.Image']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Ad.photo_hash'
        db.add_column('vkontakte_ads_ad', 'photo_hash', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Ad.photo'
        db.add_column('vkontakte_ads_ad', 'photo', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Ad.hash'
        db.add_column('vkontakte_ads_ad', 'hash', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Ad.server'
        db.add_column('vkontakte_ads_ad', 'server', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Deleting field 'Ad.image'
        db.delete_column('vkontakte_ads_ad', 'image_id')
    ...
    models = {
        ...
        'vkontakte_ads.ad': {
            ...
            'fetched': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'ad'", 'unique': 'True', 'null': 'True', 'to': "orm['vkontakte_ads.Image']"}),
        ...
        'vkontakte_ads.campaign': {
            ...
            'client': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'campaigns'", 'null': 'True', 'to': "orm['vkontakte_ads.Client']"}),
        ...
        'vkontakte_ads.image': {
            ...
            'aid': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'fetched': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            ...
            'photo_hash': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'server': ('django.db.models.fields.PositiveIntegerField', [], {'blank': 'True'}),
