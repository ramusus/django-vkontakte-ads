...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Ad.targeting'
        db.delete_column('vkontakte_ads_ad', 'targeting_id')
    ...
    def backwards(self, orm):
        # Adding field 'Ad.targeting'
        db.add_column('vkontakte_ads_ad', 'targeting',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='ad', unique=True, null=True, to=orm['vkontakte_ads.Targeting']),
                      keep_default=False)

        # Adding field 'Ad.image'
        db.add_column('vkontakte_ads_ad', 'image',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='ad', unique=True, null=True, to=orm['vkontakte_ads.Image']),
                      keep_default=False)

        # Adding field 'Ad.layout'
        db.add_column('vkontakte_ads_ad', 'layout',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='ad', unique=True, null=True, to=orm['vkontakte_ads.Layout']),
                      keep_default=False)
