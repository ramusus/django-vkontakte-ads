...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Layout.title'
        db.alter_column('vkontakte_ads_layout', 'title', self.gf('vkontakte_api.fields.CharRangeLengthField')(max_length=50))


    def backwards(self, orm):
        
        # Changing field 'Layout.title'
        db.alter_column('vkontakte_ads_layout', 'title', self.gf('vkontakte_api.fields.CharRangeLengthField')(max_length=25))
