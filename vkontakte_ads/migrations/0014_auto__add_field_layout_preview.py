...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Layout.preview'
        db.add_column('vkontakte_ads_layout', 'preview', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Layout.preview'
        db.delete_column('vkontakte_ads_layout', 'preview')
