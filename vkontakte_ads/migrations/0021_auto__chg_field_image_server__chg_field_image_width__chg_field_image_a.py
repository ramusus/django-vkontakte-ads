...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Image.server'
        db.alter_column('vkontakte_ads_image', 'server', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Image.width'
        db.alter_column('vkontakte_ads_image', 'width', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Image.aid'
        db.alter_column('vkontakte_ads_image', 'aid', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Image.height'
        db.alter_column('vkontakte_ads_image', 'height', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Targeting.count'
        db.alter_column('vkontakte_ads_targeting', 'count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    def backwards(self, orm):

        # Changing field 'Image.server'
        db.alter_column('vkontakte_ads_image', 'server', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))

        # Changing field 'Image.width'
        db.alter_column('vkontakte_ads_image', 'width', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))

        # Changing field 'Image.aid'
        db.alter_column('vkontakte_ads_image', 'aid', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))

        # Changing field 'Image.height'
        db.alter_column('vkontakte_ads_image', 'height', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))

        # Changing field 'Targeting.count'
        db.alter_column('vkontakte_ads_targeting', 'count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
    models = {
        ...
        'vkontakte_ads.targeting': {
            ...
            'count': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
