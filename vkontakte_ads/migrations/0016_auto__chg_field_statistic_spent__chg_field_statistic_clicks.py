...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Statistic.spent'
        db.alter_column('vkontakte_ads_statistic', 'spent', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'Statistic.clicks'
        db.alter_column('vkontakte_ads_statistic', 'clicks', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
