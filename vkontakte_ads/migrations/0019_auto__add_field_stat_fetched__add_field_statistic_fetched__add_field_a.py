...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Stat.fetched'
        db.add_column('vkontakte_ads_stat', 'fetched', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'Statistic.fetched'
        db.add_column('vkontakte_ads_statistic', 'fetched', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'Ad.fetched'
        db.add_column('vkontakte_ads_ad', 'fetched', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'Account.fetched'
        db.add_column('vkontakte_ads_account', 'fetched', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'Campaign.fetched'
        db.add_column('vkontakte_ads_campaign', 'fetched', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'Layout.fetched'
        db.add_column('vkontakte_ads_layout', 'fetched', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'Report.fetched'
        db.add_column('vkontakte_ads_report', 'fetched', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'Client.fetched'
        db.add_column('vkontakte_ads_client', 'fetched', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'Targeting.fetched'
        db.add_column('vkontakte_ads_targeting', 'fetched', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'Budget.fetched'
        db.add_column('vkontakte_ads_budget', 'fetched', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Stat.fetched'
        db.delete_column('vkontakte_ads_stat', 'fetched')

        # Deleting field 'Statistic.fetched'
        db.delete_column('vkontakte_ads_statistic', 'fetched')

        # Deleting field 'Ad.fetched'
        db.delete_column('vkontakte_ads_ad', 'fetched')

        # Deleting field 'Account.fetched'
        db.delete_column('vkontakte_ads_account', 'fetched')

        # Deleting field 'Campaign.fetched'
        db.delete_column('vkontakte_ads_campaign', 'fetched')

        # Deleting field 'Layout.fetched'
        db.delete_column('vkontakte_ads_layout', 'fetched')

        # Deleting field 'Report.fetched'
        db.delete_column('vkontakte_ads_report', 'fetched')

        # Deleting field 'Client.fetched'
        db.delete_column('vkontakte_ads_client', 'fetched')

        # Deleting field 'Targeting.fetched'
        db.delete_column('vkontakte_ads_targeting', 'fetched')

        # Deleting field 'Budget.fetched'
        db.delete_column('vkontakte_ads_budget', 'fetched')
