...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Layout.description'
        db.alter_column('vkontakte_ads_layout', 'description', self.gf('vkontakte_api.fields.CharRangeLengthField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Layout.description'
        db.alter_column('vkontakte_ads_layout', 'description', self.gf('vkontakte_api.fields.CharRangeLengthField')(max_length=60))
