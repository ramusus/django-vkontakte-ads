...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ad.archived'
        db.add_column('vkontakte_ads_ad', 'archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Campaign.archived'
        db.add_column('vkontakte_ads_campaign', 'archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Client.archived'
        db.add_column('vkontakte_ads_client', 'archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Ad.archived'
        db.delete_column('vkontakte_ads_ad', 'archived')

        # Deleting field 'Campaign.archived'
        db.delete_column('vkontakte_ads_campaign', 'archived')

        # Deleting field 'Client.archived'
        db.delete_column('vkontakte_ads_client', 'archived')
    ...
    models = {
        ...
        'vkontakte_ads.ad': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bulk_ads'", 'to': "orm['vkontakte_ads.Account']"}),
            'all_limit': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'approved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'archived': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'campaign': ('smart_selects.db_fields.ChainedForeignKey', [], {'related_name': "'bulk_ads'", 'to': "orm['vkontakte_ads.Campaign']"}),
