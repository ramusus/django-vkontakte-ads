...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Account.account_id'
        db.delete_column('vkontakte_ads_account', 'account_id')

    def backwards(self, orm):
        # Adding field 'Account.account_id'
        db.add_column('vkontakte_ads_account', 'account_id',
