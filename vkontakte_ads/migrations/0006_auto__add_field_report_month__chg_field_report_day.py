...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Report.month'
        db.add_column('vkontakte_ads_report', 'month', self.gf('django.db.models.fields.CharField')(max_length=7, null=True), keep_default=False)

        # Changing field 'Report.day'
        db.alter_column('vkontakte_ads_report', 'day', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'Report.month'
        db.delete_column('vkontakte_ads_report', 'month')

        # Changing field 'Report.day'
        db.alter_column('vkontakte_ads_report', 'day', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 2, 1)))
