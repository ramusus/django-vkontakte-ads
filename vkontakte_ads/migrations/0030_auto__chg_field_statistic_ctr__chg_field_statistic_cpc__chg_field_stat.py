...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Statistic.ctr'
        db.alter_column('vkontakte_ads_statistic', 'ctr', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Statistic.cpc'
        db.alter_column('vkontakte_ads_statistic', 'cpc', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Statistic.cpm'
        db.alter_column('vkontakte_ads_statistic', 'cpm', self.gf('django.db.models.fields.FloatField')(null=True))
    def backwards(self, orm):

        # Changing field 'Statistic.ctr'
        db.alter_column('vkontakte_ads_statistic', 'ctr', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'Statistic.cpc'
        db.alter_column('vkontakte_ads_statistic', 'cpc', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'Statistic.cpm'
        db.alter_column('vkontakte_ads_statistic', 'cpm', self.gf('django.db.models.fields.FloatField')(default=0))
    models = {
