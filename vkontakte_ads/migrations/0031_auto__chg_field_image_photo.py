...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Image.photo'
        db.alter_column('vkontakte_ads_image', 'photo', self.gf('django.db.models.fields.CharField')(max_length=200))
    def backwards(self, orm):

        # Changing field 'Image.photo'
        db.alter_column('vkontakte_ads_image', 'photo', self.gf('django.db.models.fields.CharField')(max_length=50))
    models = {
