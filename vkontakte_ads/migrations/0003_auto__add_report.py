...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Report'
        db.create_table('vkontakte_ads_report', (
            ...
            ('money', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ...
            ('campaign_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('ctr', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=3)),
            ('time_from', self.gf('django.db.models.fields.DateTimeField')()),
            ('time_to', self.gf('django.db.models.fields.DateTimeField')()),
            ('group_time', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('group_ads', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('stats_type', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
        ))
        db.send_create_signal('vkontakte_ads', ['Report'])


    def backwards(self, orm):
        
        # Deleting model 'Report'
        db.delete_table('vkontakte_ads_report')
