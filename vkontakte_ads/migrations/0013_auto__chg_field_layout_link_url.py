...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Layout.link_url'
        db.alter_column('vkontakte_ads_layout', 'link_url', self.gf('django.db.models.fields.URLField')(max_length=500))


    def backwards(self, orm):
        
        # Changing field 'Layout.link_url'
        db.alter_column('vkontakte_ads_layout', 'link_url', self.gf('django.db.models.fields.URLField')(max_length=200))
