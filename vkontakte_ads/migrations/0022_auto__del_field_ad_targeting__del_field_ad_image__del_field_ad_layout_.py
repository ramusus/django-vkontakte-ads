...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.ad'
        db.add_column('vkontakte_ads_image', 'ad',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=None, related_name='image', unique=True, to=orm['vkontakte_ads.Ad']),
                      keep_default=False)

        # Adding field 'Image.post_url'
        db.add_column('vkontakte_ads_image', 'post_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Layout.ad'
        db.add_column('vkontakte_ads_layout', 'ad',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='layout', unique=True, null=True, to=orm['vkontakte_ads.Ad']),
                      keep_default=False)

        # Adding field 'Targeting.ad'
        db.add_column('vkontakte_ads_targeting', 'ad',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='targeting', unique=True, null=True, to=orm['vkontakte_ads.Ad']),
                      keep_default=False)

#from vkontakte_api.vkontakte_ads.models import Ad, Targeting, Layout
#for ad in Ad.objects.all():
#    if ad.targeting_id:
#        t = Targeting.objects.get(id=ad.targeting_id)
#        t.ad = ad
#        t.save()
#    if ad.layout_id:
#        t = Layout.objects.get(id=ad.layout_id)
#        t.ad = ad
#        t.save()

    def backwards(self, orm):

        # Deleting field 'Image.ad'
        db.delete_column('vkontakte_ads_image', 'ad_id')

        # Deleting field 'Image.post_url'
        db.delete_column('vkontakte_ads_image', 'post_url')

        # Deleting field 'Layout.ad'
        db.delete_column('vkontakte_ads_layout', 'ad_id')

        # Deleting field 'Targeting.ad'
        db.delete_column('vkontakte_ads_targeting', 'ad_id')
