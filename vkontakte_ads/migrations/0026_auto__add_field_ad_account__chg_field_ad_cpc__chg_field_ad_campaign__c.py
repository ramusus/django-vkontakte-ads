...
from vkontakte_ads.models import Ad

class Migration(SchemaMigration):

    def forwards(self, orm):
        # Adding field 'Ad.account'
        db.add_column('vkontakte_ads_ad', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='ads', to=orm['vkontakte_ads.Account']),
                      keep_default=False)

        # Changing field 'Ad.cpc'
        db.alter_column('vkontakte_ads_ad', 'cpc', self.gf('vkontakte_api.fields.IntegerRangeField')(null=True))

        # Changing field 'Ad.campaign'
        db.alter_column('vkontakte_ads_ad', 'campaign_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['vkontakte_ads.Campaign']))

        # Changing field 'Campaign.client'
        db.alter_column('vkontakte_ads_campaign', 'client_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(null=True, to=orm['vkontakte_ads.Client']))
    def backwards(self, orm):
        # Deleting field 'Ad.account'
        db.delete_column('vkontakte_ads_ad', 'account_id')


        # Changing field 'Ad.cpc'
        db.alter_column('vkontakte_ads_ad', 'cpc', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Ad.campaign'
        db.alter_column('vkontakte_ads_ad', 'campaign_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vkontakte_ads.Campaign']))

        # Changing field 'Campaign.client'
        db.alter_column('vkontakte_ads_campaign', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['vkontakte_ads.Client']))
    models = {
