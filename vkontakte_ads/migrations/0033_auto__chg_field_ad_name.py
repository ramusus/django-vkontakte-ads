...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ad.name'
        db.alter_column('vkontakte_ads_ad', 'name', self.gf('vkontakte_api.fields.CharRangeLengthField')(max_length=100))
    def backwards(self, orm):

        # Changing field 'Ad.name'
        db.alter_column('vkontakte_ads_ad', 'name', self.gf('vkontakte_api.fields.CharRangeLengthField')(max_length=60))
    models = {
