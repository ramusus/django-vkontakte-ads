...
from vkontakte_ads.models import Statistic

class Migration(SchemaMigration):

    def forwards(self, orm):

        # Changing field 'Statistic.spent'
        db.alter_column('vkontakte_ads_statistic', 'spent', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Statistic.impressions'
        db.alter_column('vkontakte_ads_statistic', 'impressions', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Statistic.clicks'
        db.alter_column('vkontakte_ads_statistic', 'clicks', self.gf('django.db.models.fields.PositiveIntegerField')())


    def backwards(self, orm):

        # Changing field 'Statistic.spent'
        db.alter_column('vkontakte_ads_statistic', 'spent', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Statistic.impressions'
        db.alter_column('vkontakte_ads_statistic', 'impressions', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Statistic.clicks'
        db.alter_column('vkontakte_ads_statistic', 'clicks', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
